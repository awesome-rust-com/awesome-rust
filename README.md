...
* [elicpeter/nyx](https://github.com/elicpeter/nyx) — Local-first security scanner with browser UI. Cross-language taint analysis, flow visualiser, and offline triage — no cloud, no account. [Website](https://nyxscan.dev/)
