...
* [NSGA RS](https://crates.io/crates/nsga-rs) - A Rust framework for solving multi-objective optimisation problems using the NSGA family of multi-objective evolutionary algorithms. 
